  ...
  return (
    <Grid container className='second-section-container'>
      <Grid item lg={8} xs={12} className='second-section-text-container'>
        ...
        <Typography className='first-section-text-subtitle-1'>You do not need a big place to start your new adventure</Typography>
        <Typography className='first-section-text-subtitle-2'>Your ideal plant is waiting for you!</Typography>
      </Grid>
